...
export const MODULES: ModuleDef[] = [
  ...
  {
    id: "card_installment",
    technicalName: "card_installment",
    displayName: "Card installment",
    version: "1.0.0",
    depends: [],
    category: "payments",
    priority: "P1",
    importance: 78,
    summary: "Base de cuotas y coeficientes de tarjetas (Payway).",
    testPlan: [
      {
        id: "ci-1",
        title: "Instalar módulo",
        detail: "Ruta payment_pay_way/card_installment.",
      },
      {
        id: "ci-2",
        title: "CRUD AccountCard",
        detail: "Crear tarjeta con installments y coeficientes.",
      },
      {
        id: "ci-3",
        title: "Cálculo de cuotas",
        detail: "Verificar fee/coeficiente decimal en escenarios demo.",
      },
      {
        id: "ci-4",
        title: "Menús y security rules",
        detail: "Acceso por compañía / ir_rule.",
      },
    ],
  },
  {
    id: "payment_pay_way",
    technicalName: "payment_pay_way",
    displayName: "Payway Payment Provider",
    version: "17.0.1.1.0",
    depends: ["card_installment"],
    category: "payments",
    priority: "P1",
    importance: 85,
    summary: "Proveedor Payway/Decidir con cuotas.",
    testPlan: [
      {
        id: "ppw-1",
        title: "Instalar (account_debit_note, phone_validation)",
        detail: "Confirmar deps nativas Odoo 19.",
      },
      {
        id: "ppw-2",
        title: "Configurar provider Payway",
        detail: "Credenciales Decidir, métodos y cards.",
      },
      {
        id: "ppw-3",
        title: "Pago con cuotas",
        detail: "Checkout eligiendo installment; tx correcta.",
      },
      {
        id: "ppw-4",
        title: "JS decidir / paymentForm",
        detail: "Assets frontend cargan sin error de consola.",
      },
      {
        id: "ppw-5",
        title: "Tokens y transactions backend",
        detail: "Vistas payment_transaction y token sin traceback.",
      },
    ],
  },
  {
